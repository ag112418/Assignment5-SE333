error id: file://<WORKSPACE>/test/java/org/example/Amazon/AmazonIntegrationTest.java:_empty_/ItemType#
file://<WORKSPACE>/test/java/org/example/Amazon/AmazonIntegrationTest.java
empty definition using pc, found symbol in pc: _empty_/ItemType#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 1865
uri: file://<WORKSPACE>/test/java/org/example/Amazon/AmazonIntegrationTest.java
text:
```scala
